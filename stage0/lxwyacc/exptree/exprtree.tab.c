...
{
       5,     7,     6,     9,    10,    13,    14,    15,    16,     7,
       8,     9,    10,     1,    10,    12,     0,     9,    10,     2,
       7,     8,     9,    10,    11
};

static const yytype_int8 yycheck[] =
{
       2,     4,     0,     6,     7,     7,     8,     9,    10,     4,
       5,     6,     7,     3,     7,    10,    -1,     6,     7,     9,
       4,     5,     6,     7,     8
};
...
#line 1078 "exprtree.tab.c"
    break;

  case 3: /* expr: expr PLUS expr  */
#line 31 "exprtree.y"
    {(yyval.no)=makeOperatorNode('+',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1084 "exprtree.tab.c"
    break;

  case 4: /* expr: expr MINUS expr  */
#line 33 "exprtree.y"
    {(yyval.no)=makeOperatorNode('-',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1090 "exprtree.tab.c"
    break;

  case 5: /* expr: expr MUL expr  */
#line 35 "exprtree.y"
    {(yyval.no)=makeOperatorNode('*',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1096 "exprtree.tab.c"
    break;

  case 6: /* expr: expr DIV expr  */
#line 37 "exprtree.y"
    {(yyval.no)=makeOperatorNode('/',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1102 "exprtree.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 39 "exprtree.y"
    {(yyval.no)=(yyvsp[-1].no);}
#line 1108 "exprtree.tab.c"
    break;

  case 8: /* expr: NUM  */
#line 40 "exprtree.y"
          {(yyval.no)=(yyvsp[0].no);}
#line 1114 "exprtree.tab.c"
    break;


#line 1118 "exprtree.tab.c"
