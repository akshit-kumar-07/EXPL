...
static const char *const yytname[] =
{
  ...
  "WRITE", "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "NUM", "ID", "';'",
...
{
       2,    16,     7,    20,    21,    24,    27,    22,   -17,   -17,
     -17,   -17,   -17,   -17,    28,    -4,    -4,    26,   -17,    29,
     -17,   -17,    -4,    -6,    23,   -17,    30,     9,    -4,    -4,
      -4,    -4,    32,   -17,   -17,   -17,    14,    14,   -17,   -17,
     -17
};
...
{
      24,    28,    29,    30,    31,     1,    27,    12,    20,    21,
      32,    22,    36,    37,    38,    39,    28,    29,    30,    31,
       3,     4,     5,    30,    31,    35,    17,     4,     5,     6,
      28,    29,    30,    31,    13,     6,    14,    33,    16,    15,
      25,    19,    18,     0,    34,    26,    40
};

static const yytype_int8 yycheck[] =
{
      16,     7,     8,     9,    10,     3,    22,     0,    12,    13,
      16,    15,    28,    29,    30,    31,     7,     8,     9,    10,
       4,     5,     6,     9,    10,    16,     4,     5,     6,    13,
       7,     8,     9,    10,    14,    13,    15,    14,    11,    15,
      14,    13,     7,    -1,    14,    16,    14
};
...
{
       0,     3,    18,     4,     5,     6,    13,    19,    20,    21,
      22,    23,     0,    14,    15,    15,    11,     4,    20,    13,
      12,    13,    15,    24,    24,    14,    16,    24,     7,     8,
       9,    10,    16,    14,    14,    16,    24,    24,    24,    24,
      14
};
...
#line 44 "parser.y"
        {
            (yyval.node)=createNode(1,0,NODE_CONN,NULL,(yyvsp[-1].node),(yyvsp[0].node));
        }
...
#line 52 "parser.y"
                                {(yyval.node) = createNode(1, 0, NODE_READ, NULL, (yyvsp[-2].node), NULL);}
#line 1157 "parser.tab.c"
    break;

  case 10: /* OutputStmt: WRITE '(' expr ')' ';'  */
#line 55 "parser.y"
                                   {(yyval.node) = createNode(1, 0, NODE_WRITE, NULL, (yyvsp[-2].node), NULL);}
#line 1163 "parser.tab.c"
    break;

  case 11: /* AsgStmt: ID ASSIGN expr ';'  */
#line 58 "parser.y"
                                 {(yyval.node) = createNode(1, 0, NODE_ASSIGN, NULL, (yyvsp[-3].node), (yyvsp[-1].node));}
#line 1169 "parser.tab.c"
    break;

  case 12: /* expr: expr PLUS expr  */
#line 61 "parser.y"
                        {(yyval.node) = createNode(1, 0, NODE_PLUS, NULL, (yyvsp[-2].node), (yyvsp[0].node));}
#line 1175 "parser.tab.c"
    break;

  case 13: /* expr: expr MINUS expr  */
#line 62 "parser.y"
                        {(yyval.node) = createNode(1, 0, NODE_MINUS, NULL, (yyvsp[-2].node), (yyvsp[0].node));}
#line 1181 "parser.tab.c"
    break;

  case 14: /* expr: expr MUL expr  */
#line 63 "parser.y"
                        {(yyval.node) = createNode(1, 0, NODE_MUL, NULL, (yyvsp[-2].node), (yyvsp[0].node));}
#line 1187 "parser.tab.c"
    break;

  case 15: /* expr: expr DIV expr  */
#line 64 "parser.y"
                        {(yyval.node) = createNode(1, 0, NODE_DIV, NULL, (yyvsp[-2].node), (yyvsp[0].node));}
