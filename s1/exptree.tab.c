...
#line 27 "exptree.y"
        {
            (yyval.no)=(yyvsp[0].no);
            int r=codeGen((yyvsp[-1].no));
            print(r);
            exit(0);
        }
#line 1084 "exptree.tab.c"
    break;

  case 3: /* expr: expr PLUS expr  */
#line 35 "exptree.y"
                       {(yyval.no) = makeOperatorNode('+',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1090 "exptree.tab.c"
    break;

  case 4: /* expr: expr MINUS expr  */
#line 36 "exptree.y"
                      {(yyval.no) = makeOperatorNode('-',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1096 "exptree.tab.c"
    break;

  case 5: /* expr: expr MUL expr  */
#line 37 "exptree.y"
                  {(yyval.no) = makeOperatorNode('*',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1102 "exptree.tab.c"
    break;

  case 6: /* expr: expr DIV expr  */
#line 38 "exptree.y"
                  {(yyval.no) = makeOperatorNode('/',(yyvsp[-2].no),(yyvsp[0].no));}
#line 1108 "exptree.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 39 "exptree.y"
                  {(yyval.no) = (yyvsp[-1].no);}
#line 1114 "exptree.tab.c"
    break;

  case 8: /* expr: NUM  */
#line 40 "exptree.y"
          {(yyval.no) = (yyvsp[0].no);}
#line 1120 "exptree.tab.c"
    break;


#line 1124 "exptree.tab.c"
