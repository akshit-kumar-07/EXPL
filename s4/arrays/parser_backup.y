...
%token START END READ WRITE PLUS MINUS MUL DIV ASSIGN NUM ID IF THEN ELSE ENDIF WHILE DO ENDWHILE BREAK CONTINUE LT GT EQ NEQ LE GE REPEAT UNTIL ENDREPEAT DOWHILE ENDDOWHILE DECL ENDDECL INT STR STRVAL MOD
%left PLUS MINUS
%left MUL DIV

%type <node> NUM ID START END READ WRITE PLUS MINUS MUL DIV ASSIGN IF THEN ELSE ENDIF WHILE DO ENDWHILE BREAK CONTINUE LT GT EQ NEQ LE GE REPEAT DOWHILE UNTIL ENDDOWHILE ENDREPEAT DECL ENDDECL INT STR STRVAL MOD
